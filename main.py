...
COINS = ["BTC-USDT-SWAP", "ETH-USDT-SWAP", "XRP-USDT-SWAP", "BNB-USDT-SWAP", "SOL-USDT-SWAP", "DOGE-USDT-SWAP", "ADA-USDT-SWAP", "TRX-USDT-SWAP", "AVAX-USDT-SWAP", "SUI-USDT-SWAP", "PENGU-USDT-SWAP", "RIVER-USDT-SWAP", "AAVE-USDT-SWAP"]
...
def main():
    ...
    for t in trades:
        ...
        if (t['side']=='LONG' and lo<=t['sl']) or (t['side']=='SHORT' and hi>=t['sl']):
            send_tg(f"\u274c *止損離場*\n#{t['instId']} | {curr_p}"); finished.append(t); continue
